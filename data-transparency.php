...
<head>
    <meta charset="utf-8">
    <title>Astrakit · Data Transparency</title>
    ...
    <meta name="author" content="Astrakit · Data Transparency">
        ...
        <div class="relative isolate overflow-hidden bg-gray-900">
            ...
            <div class="mx-auto max-w-7xl px-6 pt-20 pb-24 sm:pb-32 lg:flex lg:px-8 animate-fade">
                <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8 mt-20">
                    <h1 class="mt-10 text-5xl font-bold tracking-tight text-white sm:text-7xl">Data Transparency</h1>
                    <p class="mt-6 text-lg leading-8 text-gray-300">Our Data Transparency policy outlines how Astrakit handles your data. We are committed to maintaining the privacy and security of your information. By using our services, you agree to the collection and use of information in accordance with this policy. We may update this policy from time to time, so please review it regularly to stay informed of any changes.</p>
