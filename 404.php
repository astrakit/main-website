...
<head>
  ...
  <meta name="author" content="Astrakit · 404">
    ...
    <div class="relative isolate overflow-hidden bg-gray-900">
      ...
      <div class="mx-auto max-w-7xl px-6 pt-20 pb-24 sm:pb-32 lg:flex lg:px-8 animate-fade">
        <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8 mt-20">
          <h1 class="mt-10 text-5xl font-bold tracking-tight text-white sm:text-7xl">Whoops...</h1>
          <p class="mt-6 text-lg leading-8 text-gray-300">It looks like the page you are looking for doesn't exist. But don't worry, you can explore our website to find what you need. Use the navigation below to get back on track.</p>
